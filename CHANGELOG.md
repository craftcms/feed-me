...
- Fixed a PHP error that occurred if the `enabledTabs` setting was set to an array in `config/feed-me.php`. ([#1131](https://github.com/craftcms/feed-me/issues/1131))
