...
- Fixed a bug where that could happen when importing where a Category could become orphaned if the parent was disabled. ([#555](https://github.com/craftcms/feed-me/issues/555))
