...
Craft.FeedMe.Help = Garnish.Base.extend({
    widgetId: 0,
    loading: false,
    ...
    init: function() {
        ...
        Craft.FeedMe.Help.widgets[this.widgetId] = this;
    ...
    sendMessage: function() {
        ...
        this.$form.attr('action', Craft.getActionUrl('feed-me/help/send-support-request'));
    ...
    parseResponse: function(response, textStatus) {
        ...
        if (response.success) {
            Craft.cp.displayNotice(Craft.t('feed-me', 'Message sent successfully.'));
            this.$message.val('');
...
(function(root, factory) {
    ...
    $.extend(Selectize.prototype, {
        ...
        setup: function() {
            ...
            $control_input    = $('<input type="text" autocomplete="false" />').appendTo($control).attr('tabindex', $input.is(':disabled') ? '-1' : self.tabIndex);
            /* END HACK */
