...
$(document).on("click","input[data-action]",function(e){var t=$(this).parents("form"),n=$(this).data("action");t.find('input[name="action"]').val(n),t.submit()}),$(document).on("change",".log-type-form .select",function(e){e.preventDefault(),$(this).parents("form").submit()}),
