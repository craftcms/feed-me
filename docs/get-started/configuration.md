...
- `parseTwig` — Whether to parse field data and default values for Twig. Disabled by default. If you enable this option, you should also ensure that [`enableTwigSandbox`](https://craftcms.com/docs/5.x/reference/config/general.html#enabletwigsandbox) is enabled in your Craft CMS installation to prevent malicious code from being executed.
